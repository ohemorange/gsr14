...
class Event(models.Model):
    ...
    recommendation_1 = models.ForeignKey(Recommendation, null=True, related_name='event')
    recommendation_2 = models.ForeignKey(Recommendation, null=True, related_name='event')
    recommendation_3 = models.ForeignKey(Recommendation, null=True, related_name='event')
