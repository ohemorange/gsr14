...
class Event(models.Model):
    ...
    recommendation_1 = models.ForeignKey(Recommendation, null=True, related_name='event_1')
    recommendation_2 = models.ForeignKey(Recommendation, null=True, related_name='event_2')
    recommendation_3 = models.ForeignKey(Recommendation, null=True, related_name='event_3')
